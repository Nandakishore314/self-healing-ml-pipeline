...
@patch("src.app.chat_sessions", new_callable=dict)
@patch("google.generativeai.GenerativeModel")
def test_chatbot_endpoint_with_memory(mock_gen_model, mock_chat_sessions):
    ...
    # Assertions validating status and registration handling inside your endpoint
    assert (
